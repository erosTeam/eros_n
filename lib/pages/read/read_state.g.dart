...
_ReadState _$ReadStateFromJson(Map<String, dynamic> json) => _ReadState(
  ...
  loadCompleteIndexSet:
      (json['load_complete_index_set'] as List<dynamic>?)
          ?.map((e) => (e as num).toInt())
          .toSet() ??
      const {},
);

Map<String, dynamic> _$ReadStateToJson(_ReadState instance) =>
    <String, dynamic>{
