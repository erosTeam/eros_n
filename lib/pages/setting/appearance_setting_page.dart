    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: <Widget>[
          ...
          Consumer(
            builder: (context, ref, child) {
              final supportDynamicColors = ref.watch(
                settingsProvider.select(
                  (settings) => settings.supportDynamicColors,
                ),
              );
                    ...
                    itemBuilder: (context, index) {
                      ...
                      Widget selector = ThemeSelector(
                        ...
                        selected:
                            ...
                            ref.watch(
                              settingsProvider.select(
                                (settings) => settings.themeColorLabel,
                              ),
                            ),
                        name: color.key,
                        onTap: () {
            ...
            builder: (context, ref, child) {
              ...
              return RadioDialogListTile<ListModel>(
                ...
                radioTitleMap: {
                  ...
                  ListModel.waterfallCompact: Text(
                    L10n.of(context).waterfall_compact,
                  ),
                },
                onChanged: (value) {
          ...
          Consumer(
            builder: (context, ref, child) {
              final tagLayoutOnItem = ref.watch(
                settingsProvider.select((settings) => settings.tagLayoutOnItem),
              );
              return RadioDialogListTile<TagLayoutOnItem>(
                ...
                radioTitleMap: {
                  ...
                  TagLayoutOnItem.singleLine: Text(
                    L10n.of(context).single_line,
                  ),
                  // TagLayoutOnCard.row: Text('Row'),
                },
                onChanged: (value) {
