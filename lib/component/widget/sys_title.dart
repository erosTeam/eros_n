...
class SysTitle extends StatefulWidget  {
  ...
  static final StreamController<DesktopTitle> _currentController = StreamController.broadcast();
...
class _SysTitleState extends State<SysTitle> {
  ...
  Widget build(BuildContext context) {
    final desktopTitle = DesktopTitle(widget.title, titleVisible: widget.desktopTitleVisible, buttonVisible: widget.desktopButtonVisible);
